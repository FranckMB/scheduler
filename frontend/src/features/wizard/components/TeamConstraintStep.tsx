...
export default function TeamConstraintStep() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-bold text-fg-primary">Contraintes equipes</h2>
        <p className="text-sm text-fg-muted">
          Creneaux preferes, salle preferee et severite pour chaque equipe
        </p>
      </div>
      ...
      <section className="glass rounded-lg border border-border-subtle p-4">
        <div className="mb-4 flex items-center justify-between">
          <div>
            <h3 className="text-sm font-semibold text-fg-primary">Contraintes par equipe</h3>
            <p className="text-xs text-fg-muted">Associez des contraintes de creneau a chaque equipe</p>
          </div>
          <button
            type="button"
