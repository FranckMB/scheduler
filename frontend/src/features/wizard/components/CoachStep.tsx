  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-neutral-900">Coaches</h2>
          <p className="text-sm text-neutral-500">
            Ajoutez les coaches et leurs indisponibilités récurrentes
          </p>
        </div>
        <button
          type="button"
      ...
      {data.coaches.length === 0 && (
        <div className="rounded-lg border-2 border-dashed border-neutral-200 bg-neutral-50 p-8 text-center">
          <p className="text-neutral-500">Aucun coach ajouté. Cliquez sur le bouton ci-dessus pour commencer.</p>
        </div>
      )}
      ...
      {expanded && (
        <div className="border-t border-neutral-100 px-4 py-3">
          <div className="mb-3 flex items-center justify-between">
            <h4 className="text-sm font-semibold text-neutral-700">Indisponibilités récurrentes</h4>
            <button
              type="button"
          ...
          {coach.unavailabilities.length === 0 && (
            <p className="text-xs text-neutral-400">Aucune indisponibilité</p>
          )}
            ...
            {coach.unavailabilities.map((unavail) => (
              ...
              >
                ...
                <input
                  ...
                  className="w-14 rounded border border-neutral-300 px-2 py-1 text-sm"
                />
                <span className="text-xs text-neutral-500">à</span>
                <input
                  type="number"
                  min={0}
                  max={23}
