...
const sp = (over: Partial<SchedulePlan>): SchedulePlan => ({ id: "pl", type: "HOLIDAY", name: "Plan", startDate: "2026-07-06", calendarEntryId: "e1", chosenScheduleId: null, teamSelectionInitialized: false, hasVersions: false, ...over });
