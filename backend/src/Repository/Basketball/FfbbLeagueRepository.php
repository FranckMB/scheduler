...
namespace App\Repository\Basketball;
...
final class FfbbLeagueRepository extends ServiceEntityRepository
{
    ...
    {
        $onConflict = $update
            ? 'DO UPDATE SET name = EXCLUDED.name, address = EXCLUDED.address, postal_code = EXCLUDED.postal_code, city = EXCLUDED.city, phone = EXCLUDED.phone, email = EXCLUDED.email, logo_url = EXCLUDED.logo_url, website = EXCLUDED.website, fetched_at = EXCLUDED.fetched_at'
            : 'DO NOTHING';
        $this->getEntityManager()->getConnection()->executeStatement(
            'INSERT INTO ffbb_league (id, code, name, address, postal_code, city, phone, email, logo_url, website, fetched_at)
             VALUES (:id, :code, :name, :address, :postalCode, :city, :phone, :email, :logoUrl, :website, :fetchedAt)
            ...
            [
                ...
                'phone' => $l->getPhone(), 'email' => $l->getEmail(), 'logoUrl' => $l->getLogoUrl(), 'website' => $l->getWebsite(),
