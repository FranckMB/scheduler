...
#[ApiResource(shortName: 'CoachUnavailability', operations: [
    new GetCollection(),
    new Get(),
    new Post(),
    new Put(),
    new Delete(),
], input: CoachUnavailabilityInput::class, paginationEnabled: true, paginationItemsPerPage: 30, provider: CoachUnavailabilityStateProvider::class, processor: CoachUnavailabilityStateProcessor::class)]
