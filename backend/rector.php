...
return RectorConfig::configure()
    ...
    // stack étant désormais homogène en 7.4 (P4-31), aucun set Symfony 8.0 ne
    // s'active : plus aucune exception à déclarer ici. La précédente
    ...
    // registered » une fois l'alignement fait.
