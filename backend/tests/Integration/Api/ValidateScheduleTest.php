...
/**
 * BL3 — a COMPLETED schedule can be (re)designated as the season baseline; only
...
final class ValidateScheduleTest extends WebTestCase
{
    ...
    public function testValidateSetsSeasonBaseline(): void
    {
    ...
    public function testNonCompletedScheduleCannotBecomeBaseline(): void
    {
