...
**Pointers:** `docs/project-map.md` · `docs/glossary.md` (termes & clés de payload) · `docs/testing/testing-strategy.md` · `specs/evolution/roadmap.md` (suivi unique : carte + backlog priorisé + dette) · `docs/cleanup-candidates.md` · `docs/architecture/adr-index.md` · `specs/README.md` · commandes backend : `backend/docs/commands.md` · routes FFBB : `backend/docs/ffbb-api.md` · **ops (backups `pg_dump`/restore-check + activation Sentry 3 zones)** : `docs/ops/backup-restore.md` · **stack prod (`docker-compose.prod.yml`, images immuables, INF-03)** : `docs/ops/prod-stack.md` · **déployer (tag `v*` → ghcr.io → SSH, runbook fondateur)** : `docs/ops/deploy.md`
