...
Last verified @ 2026-08-16 (recalé ce jour : contrat backend⇄engine 2.8 → **2.9** — retrait des champs morts `temporaryLock`/`temporaryLockFor`/`temporaryMinSessionsOverride`, jamais lus par le solveur ; précédemment : 2026-08-15, contrat 2.7 → 2.8, cause STRUCTURÉE d'une séance manquante, P4-99 PR-1)
