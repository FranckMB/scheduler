...
Last verified @ 2026-08-15 (recalé ce jour : contrat backend⇄engine 2.7 → **2.8** — le diagnostic `session_below_effective_min` porte la cause STRUCTURÉE d'une séance manquante, MESURÉE à la pose, P4-99 PR-1 ; précédemment : 2026-08-14, contrat 2.6 → 2.7, bloc `implicitRules`, P2-28 PR 1)
