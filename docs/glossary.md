...
| **Tag système** (`TeamTag`) | Étiquette auto-assignée (U9…U21, SENIOR, JEUNE, EMB, BABY, FEMININE…) groupée par **axe** GENRE/NIVEAU/ÂGE. Cible de groupe des contraintes (`targetTag`). Les **tranches d'âge sont exclusives** — une équipe n'en porte qu'une, dérivée de sa catégorie par `TeamTagService::determineTagNames` : **BABY** = U5-U7 *et* « Baby basket » (rattaché par son NOM, ses âges étant nuls) · **EMB** = U9-U11 · **JEUNE** = U13-U18 · **SENIOR** = U21 et au-delà. ⚠ Une catégorie sans âge et sans « baby » au nom (« Loisir ») ne tombe dans **aucune** tranche : elle est hors de portée d'une contrainte par âge. |
