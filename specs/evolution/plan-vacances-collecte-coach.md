...
**Reste C3** : emails (envoi du lien), **digest quotidien** (« Maxime, Mara et Thomas ont répondu »), relance. L'email du coach est déjà **éditable** (wizard étape Coachs + inline dans le dialog de campagne) en préparation — **sans effet en C2**.
