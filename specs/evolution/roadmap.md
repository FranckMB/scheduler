...
|---|-------|:---:|:---:|---|
| P2-17 | **Libellé/fusion esthétique d'un créneau mutualisé (« CEC3 »)** | 🟡 | M | Besoin fondateur 2026-07-31 (périodes de vacances), **recadré 2026-08-14**. La **mécanique** est livrée (2 équipes sur un créneau à capacité 2, zéro engine — état des lieux §1.2) ; ce lot la **donne à lire** : UN créneau **nommable** — « CEC3 » pour U9F1/U9F2/U9M2 — affiché comme une seule ligne, ses équipes à l'intérieur. ⚠ **La fusion n'est PAS forcée : c'est un CHOIX du gestionnaire, par créneau** — certains partages restent deux créneaux côte à côte, d'autres se lisent comme un groupe nommé ; les deux rendus coexistent. **PR 1 (backend + exports) LIVRÉE** : colonne `group_label` (≤ 40, trim → NULL, garde « capacité ≥ 2 »), copie de période qui la porte (ADR-0002), **exclusion de la péremption** (renommer un groupe est esthétique — pas de bannière « régénérez »), titre de groupe dans le PDF + colonne « Groupe » dans l'XLSX ; le payload solveur ne bouge pas. **Reste PR 2 (frontend)** : saisir le libellé dans la grille de saisie, rendre la fusion dans la grille de planning. ⚑ **Volet « coach porteur » ANNULÉ** (validation de besoin 2026-08-14 : « 2 équipes, 2 coachs dans le même créneau, les deux présents — c'est juste esthétique » ; la décision D-14 est CONFIRMÉE, la mention d'un effet **solveur** était une surinterprétation). Le volet « geste depuis les doléances » part en **P2-27**. Preuve du besoin : une équipe « loisir » fantôme avait été créée en contournement pour représenter ce regroupement |
