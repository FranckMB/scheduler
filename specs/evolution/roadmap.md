...
3. **P2-22 — un créneau qui disparaît (gymnase fermé) ne le DIT pas** : besoin fondateur nommé (« au lieu de cacher les créneaux, afficher INDISPO ») — partiellement traité (muet sur le motif et les dates, tout-ou-rien sur le gymnase) ; fort levier terrain, trois écrans concernés, aucune API à inventer.
