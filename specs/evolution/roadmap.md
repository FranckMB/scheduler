...
**Au 2026-08-09 :**
1. **P1-3 — bridage freemium + offres** : aucune monétisation possible sans lui. **Cadrage tranché le 2026-08-09, modèle HYBRIDE** (périmètre complet gratuit, 10 générations, features off ; payants par taille ; Bêta superadmin) : **prête à implémenter**, plan en cours de révision.
