...
**Au 2026-08-09 :**
1. **P1-3 — bridage freemium** : aucune monétisation possible sans lui, spec prête. ⚠ L'**étude des tailles de clubs est LIVRÉE** (2026-08-09 → [`etude-tailles-clubs-ffbb.md`](etude-tailles-clubs-ffbb.md)) ; reste le **point de cadrage dédié** (cap générations vs équipes + PSP) — voir la ligne P1-3.
