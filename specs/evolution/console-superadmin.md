...
> **Statut** : **SA0, SA1, console read-only SA2 et SA3-A/B/C livrés** (2026-07-16) — vérité courante dans [`../courantes/superadmin-auth.md`](../courantes/superadmin-auth.md). Suite : relances SA3 → SA5.
...
| 2 | **SA0, SA1, SA2 et SA3-A/B/C sont livrés ; la suite solde SA3** (relances). |
...
- **Reste SA3** : **re-trigger manuel** non destructif depuis la vue superadmin.
