...
| `Menu` / `MenuItem` | Dropdown accessible (burger) — Esc + clic-dehors, `aria-expanded`/`role=menu`, sans dépendance externe | `label`, `trigger`, `children` / `onSelect`, `icon` | AppLayout (menu compte : Club · Profil · Thème · Logout) |
