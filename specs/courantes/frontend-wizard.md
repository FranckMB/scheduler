...
Last verified @ 2026-08-15 (recalé ce jour par P2-28 PR 3 : l'étape Contraintes gagne les onglets « Base » (règles immuables, lecture seule) et « Bien-être » (4 règles réglables Obligatoire/Objectif + seuils + Réinitialiser), remplaçant l'encart replié P4-55 ; lien « Ajuster cette règle » depuis un diagnostic du planning → atterrissage scrollé sur la règle — re-vérifié contre `ImplicitRulesPanel.tsx`, `ConstraintsStep.tsx`, `DiagnosticsPanel.tsx`, `wizard/api.ts` ; précédemment : 2026-08-14, cohérence canSplit (modale d'impact + cascade), P2-22 PR 2 (fermetures au grain JOUR), P2-17 PR 2 (`GroupLabelField`) ; 2026-08-11 : P4-55 ; 2026-08-08 : retrait `FACILITY_CAPACITY`)
