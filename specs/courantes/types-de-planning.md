...
| E5 | ✅ **Première marche livrée (2026-07-25, #10 lot C1)** : la modale **« Doléances des coachs »** est une todo-list par (équipe × semaine), ancrée à l'entrée MÈRE des vacances, ouverte de deux portes — bandeau du wizard (filtrée sur la semaine du plan courant) et carte de période au cockpit (toutes semaines). Filtres coach/équipe, coche « traité », saisie « au nom d'un coach ». Reste la collecte tokenisée (C2/C3). | 3 | — |
